...
LinkLang.create(link:'Recent Reading List', lang:'English', types:'reading')
LinkLang.create(link:'近期阅读文章', lang:'Chinese', types:'reading')
LinkLang.create(link:'最近読んでいる論文', lang:'Japanese', types:'reading')
LinkLang.create(link:'Publications and Submissions', lang:'English', types:'publication')
LinkLang.create(link:'发表或提交的论文', lang:'Chinese', types:'publication')
LinkLang.create(link:'発表したまたは提出した論文', lang:'Japanese', types:'publication')
LinkLang.create(link:'Medical Questionaire', lang:'English', types:'questionaire')
LinkLang.create(link:'医疗相关问卷', lang:'Chinese', types:'questionaire')
LinkLang.create(link:'アンケート調査', lang:'Japanese', types:'questionaire')
