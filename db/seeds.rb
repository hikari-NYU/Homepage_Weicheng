...
WorkInfo.delete_all
WorkInfo.create(work_id: 1, name: 'Technical Writing Sample - Sentence Divider', link:'https://github.com/hikari-NYU/Sentence_Divider', description:'Divides a string of characters into separated words using maximum match.', note:'', lang:'English')
